...
@pytest.mark.asyncio
class TestFetchMealRecommendationAPIController(TestIV1MealAPIsController):

    @pytest.fixture
    def valid_fetch_meal_recommendation_request_dto(
        self,
        reference_number,
    ):
    ...
    @pytest.fixture
    def mock_fetch_meal_recommendation_service(self):
    ...
    @pytest.fixture
    def mock_fetch_meal_recommendation_service_factory(
        self,
        mock_fetch_meal_recommendation_service
    ):
        """Create a mock fetch meal service factory."""
        factory = Mock()
        factory.return_value = mock_fetch_meal_recommendation_service
        return factory
    ...
    def successful_response_dto(self, urn):
        ...
        return BaseResponseDTO(
            ...
            responseMessage="Meal recommendation fetched successfully",
            responseKey="success_fetch_meal_recommendation",
            data={"meal_id": 123, "meal_name": "test_meal"}
        )

    async def test_fetch_meal_recommendation_api_controller_success(
        self,
        valid_fetch_meal_recommendation_request_dto,
        mock_request,
        mock_session,
        ...
        """Test successful meal recommendation fetch."""

        controller = FetchMealRecommendationController()
        mock_service = AsyncMock()
        mock_service.run = AsyncMock(return_value=successful_response_dto)
        mock_fetch_meal_recommendation_service_factory.return_value = (
            mock_service
        )
        ...
        response = await controller.get(
            ...
            reference_number=(
                valid_fetch_meal_recommendation_request_dto.reference_number
            ),
            food_category=(
    ...
    async def test_fetch_meal_recommendation_api_controller_bad_input_error(
        self,
        valid_fetch_meal_recommendation_request_dto,
        mock_request,
        mock_session,
        ...
        mock_fetch_meal_recommendation_service_factory.return_value.run = (
            AsyncMock(side_effect=bad_input_error)
        )
    ...
    async def test_fetch_meal_recommendation_api_controller_not_found_error(
        self,
        valid_fetch_meal_recommendation_request_dto,
        mock_request,
        mock_session,
    ...
    async def test_fetch_meal_recommendation_api_unexpected_response_error(
        self,
        valid_fetch_meal_recommendation_request_dto,
        mock_request,
        mock_session,
    ...
    async def test_fetch_meal_recommendation_api_controller_generic_exception(
        self,
        valid_fetch_meal_recommendation_request_dto,
        mock_request,
        mock_session,
        ...
        mock_fetch_meal_recommendation_service_factory.return_value.run = (
            AsyncMock(side_effect=generic_error)
        )
    ...
    async def test_fetch_meal_recommendation_api_controller_missing_user_id(
        self,
        valid_fetch_meal_recommendation_request_dto,
        mock_request,
        mock_session,
        ...
        mock_fetch_meal_recommendation_service_factory.return_value.run = (
            AsyncMock(return_value=successful_response_dto)
        )
        ...
        assert response.status_code == HTTPStatus.OK
        service_call_args = (
            mock_fetch_meal_recommendation_service_factory.call_args[1]
        )
        assert service_call_args["user_id"] is None

    async def test_fetch_meal_recommendation_api_controller_missing_user_urn(
        self,
        valid_fetch_meal_recommendation_request_dto,
        mock_request,
        mock_session,
    ...
    async def test_fetch_meal_recommendation_api_dictionary_utility_called(
        self,
        valid_fetch_meal_recommendation_request_dto,
        mock_request,
        mock_session,
    ...
    async def test_service_factory_called_with_correct_params(
        ...
        mock_fetch_meal_recommendation_service_factory.assert_called_once_with(
            urn=urn,
            user_urn=user_urn,
