...
class FetchRankingJobStatusController(IV1RankingJobController):
    """
    Controller for fetching the status of a ranking job.
    Handles GET requests for fetching the status of a ranking job.
    """
    def __init__(self, urn: str = None) -> None:
        super().__init__(urn)
        self._urn = urn
        self._user_urn = None
        self._api_name = APILK.FETCH_RANKING_JOB_STATUS
        self._user_id = None
    ...
    async def get(
        ...
        try:
            ...
            response_dto = status_ranking_job_service.run(
